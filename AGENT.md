...
- 「接下來可關注標的」至少提出 6 檔，分成核心型、衛星型、觀察型，並說明角色、催化與風險。
- 「100% 新資金配置」要做風險分散，原則上不得讓單一個股超過 50%，並保留 5-15% 現金或等待資金，除非估值安全邊際極高。
- 週報檔案存為 `reports/report_YYYY-MM-DD.md`，使用繁體中文 Markdown，讓 App 的「投資週報」頁面可直接讀取。
